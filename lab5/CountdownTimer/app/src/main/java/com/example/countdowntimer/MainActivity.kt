...
import com.example.countdowntimer.ui.TimerScreen
import com.example.countdowntimer.ui.TimerViewModel
...
class MainActivity : ComponentActivity() {
    ...
    override fun onStop() {
        ...
        if (timerViewModel.isRunning) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                if (ActivityCompat.checkSelfPermission(this,
                        Manifest.permission.POST_NOTIFICATIONS) == zPackageManager.PERMISSION_GRANTED) {
